...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Messages = __webpack_require__(202);
	...
	var App = function (_Component) {
	    ...
	    _createClass(App, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            fetch("https://slack.com/api/channels.list?token=" + _config.token).then(function (result) {
	                return result.json();
	            }).then(function (jsonResults) {
	                var channelList = jsonResults.channels.map(function (channel) {
	                    return { channelname: channel.name, channelid: channel.id };
	                });
	                _this2.setState({ channels: channelList, activeChannel: channelList[0].channelid });
	            }).catch(function (err) {
	                return console.log(err);
	            });
	            // Grab user names so that we can push them down through props and display names next to each rendered message
	            fetch("https://slack.com/api/users.list?token=" + _config.token).then(function (result) {
	                return result.json();
	            }).then(function (jsonResults) {
	                var membersList = jsonResults.members.map(function (member) {
	                    return { name: member.name, id: member.id, img: member.profile.image_32 };
	                });
	                _this2.setState({ teamUsers: membersList });
	            }).catch(function (err) {
	                return console.log(err);
	            });
	        }
	        ...
	        value: function render() {
	            if (this.state.activeChannel && this.state.teamUsers) {
	                return _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(_Channels2.default, { setActiveChannel: this.setActiveChannel,
	                        channelList: this.state.channels,
	                        activeChannel: this.state.activeChannel,
	                        handleLiClick: this.handleLiClick
	                    }),
	                    _react2.default.createElement(_Messages2.default, { activeChannel: this.state.activeChannel,
...
/***/ function(module, exports) {
	...
	var config = {
	    token: "xoxp-118239328482-147722976803-150944508418-54d60f43503cf9a9aa15ba4e44bae781"
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Channels = function (_React$Component) {
	    ...
	    function Channels(props) {
	        ...
	        return _possibleConstructorReturn(this, (Channels.__proto__ || Object.getPrototypeOf(Channels)).call(this, props));
	    }
	    ...
	    _createClass(Channels, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'ul',
	                null,
	                this.props.channelList.map(function (channel) {
	                    return _react2.default.createElement(_Channel2.default, { key: channel.channelid,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var channel = _interopRequireWildcard(_actions);
	...
	var Channel = (_dec = (0, _reactRedux.connect)(function (store) {
	    return store;
	    ...
	    function Channel(props) {
	        ...
	        _this.setActiveChannel = _this.setActiveChannel.bind(_this);
	        return _this;
	    }

	    _createClass(Channel, [{
	        key: "setActiveChannel",
	        value: function setActiveChannel(event) {
	            event.preventDefault();
...
/***/ function(module, exports, __webpack_require__) {
	...
	function fetchMessages(newChannel) {
	    console.log("fetching messages");
	    return function (dispatch) {
	        var baseUrl = "https://slack.com/api/channels.history?token=";
	        fetch(baseUrl + _config.token + "&channel=" + this.props.activeChannel).then(function (result) {
	            return result.json();
	        }).then(function (jsonResults) {
	            var messageList = jsonResults.messages.map(function (message) {
	    ...
	    _createClass(Messages, [{
	        ...
	        value: function render() {
	            ...
	            if (this.state.messages) {
	                return _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        this.state.messages.map(function (message, index) {
	                            return _react2.default.createElement(_Message2.default, { key: index,
	                                teamUsers: _this2.props.teamUsers,
	                    ...
	                    _react2.default.createElement(_Input2.default, { activeChannel: this.props.activeChannel,
	        ...
	        value: function fetchMessages() {
	            ...
	            fetch(baseUrl + _config.token + "&channel=" + this.props.activeChannel).then(function (result) {
	                ...
	                _this3.setState({ messages: messageList });
	            }).catch(function (err) {
	                return console.log(err);
	            });
	        }
	...
	var Message = function (_React$Component) {
	    ...
	    _createClass(Message, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            var userName = this.props.teamUsers.forEach(function (user) {
	                if (user.id === _this2.props.userId) {
	                    _this2.setState({ userName: user.name });
	                    return;
	                }
	            });
	        }
	...
	var Input = function (_React$Component) {
	    ...
	    _createClass(Input, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement('input', { type: 'text', minLength: '1',
	        ...
	        value: function handleSubmit(event) {
	            ...
	            event.preventDefault();
	            var baseUrl = "https://slack.com/api/chat.postMessage?token=";
	            fetch(baseUrl + _config.token + "&channel=" + this.props.activeChannel + "&text=" + encodeURIComponent(this.state.message)).then(function (response) {
	                return response.json();
	            }).then(function (jsonResponse) {
	                console.log(jsonResponse);
	                if (jsonResponse.ok) {
	                    _this2.props.fetchMessages();
	                }
	            }).catch(function (err) {
	                return console.log(err);
	            });
...
/***/ function(module, exports) {
	...
	exports.default = function (state, action) {
	    ...
	    switch (action.type) {
	        case "CHANGE_CHANNEL":
	            newState = _extends({}, state, { activeChannel: action.payload.channel });
	            break;
	        case "FETCH_MESSAGES":
	            newState = _extends({}, state, { messages: action.payload });
	            break;
	            // To-Do: error handling
	            // case "FETCH_ERROR":
	            //     state = { ...state};
	            //     break;
	            dafault: newState = _extends({}, state);
	            break;
	    }
	    return newState;
	};
